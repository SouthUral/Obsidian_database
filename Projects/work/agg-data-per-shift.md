...
- [ ] Написать модуль агрегации данных #work ;
	...
	- [ ] Сделать методы конвертации внутренних объектов в транспортные объекты и далее в json #work 📅 2024-03-04 
		- [ ] конвертация для смены #work  📅 2024-03-04 
		- [ ] конвертация для сессии #work  📅 2024-03-04 
...
- [ ] Сделать тестовый запуск сервиса #work 📅 2024-03-01 
	- [ ] проверка подключения к БД #work 📅 2024-03-01 
	- [ ] проверка запросов на получение данных по смене и по сессии #work 📅 2024-03-01 
	- [ ] проверка конвертации данных в структуру и затем в json в модуле storage #work 📅 2024-03-01 
	- [ ] проверка приема сообщения от storage, проверка конвертации сообщения #work 📅 2024-03-01 
		- [ ] конвертация в структуру ShiftObjData #work 📅 2024-03-01 
		- [ ] конвертация в структуру sessionDriverData #work 📅 2024-03-01 
