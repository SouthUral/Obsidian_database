...
- [ ] Написать модуль агрегации данных #work ;
	...
	- [ ] нужно сделать флаг для обработчика сообщений, чтобы маршрутизатор проверял состояние обработчика перед каждой отправкой сообщения, и в случает если обработчик выключился, перезапускал его, либо закрывал программу #work 📅 2024-03-11 
...
- [ ] модуль amqp
	- [ ] получение offset при восстановлении работы сервиса #work 📅 2024-03-09
		- [ ] обработка запроса от amqp в модуле storage,  на восстановление offset #work 📅 2024-03-09 
		- [ ] разработка транспортной структуры со стороны storage #work 📅 2024-03-09 
		- [ ] разработка интерфейса (скорее всего не понадобится, нужно просто передать цифру) #work 📅 2024-03-09 
