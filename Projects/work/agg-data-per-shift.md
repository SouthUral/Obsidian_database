...
- [ ] Подготовка к деплою (фикс багов) #work 📅 2024-03-15 
	- [ ] Изменить модель поведения при отключении или ошибках связанных с Rabbit и Postgres, нужно,  чтобы при ошибках подключения программа ожидала какое-то время, прежде чем отключиться, но только при ошибках подключения, остальные ошибки должны ронять программу #work 📅 2024-03-15
		- [ ] Реализовать варианты завершения работы программы #work 📅 2024-03-15 
			- [x] Завершение работы связанное с ошибкой логики (это ошибки конвертации сообщений, ошибка логики и т.д. Иными словами это ошибки не связанные с коннектами) подразумевает моментальное завершение (правильное) работы программы #work 📅 2024-03-15 ✅ 2024-03-25
	...
	- [x] Сделать систему работы с данными о сменах #work 📅 2024-03-15 ✅ 2024-03-29
		- [x] Сделать таблицы, которые будут хранить данные смен #work 📅 2024-03-15 ✅ 2024-03-29
		- [x] Сделать модуль работы с данными смены (модуль должен подгружать данные из БД, в будущем он будет делать запросы в другой сервис) #work 📅 2024-03-15 ✅ 2024-03-29
			- [x] сделать взаимодействия модуля с БД (пока нужно только забрать данные из БД) запрос должен забирать смены активные на текущую дату (что такое текущая дата?) #work 📅 2024-03-15 ✅ 2024-03-29
